...
class Customalgorithm():  # SegmentationAlgorithm is not inherited in this class anymore
    ...
    def resample(self, data, properties):
        from muti_mamba.light_training.preprocessing.resampling.default_resampling import compute_new_shape, resample_data_or_seg_to_shape
    ...
    def preprocess(self, data, properties, crop_first=True):        
        from muti_mamba.light_training.process_framework.norm import norm_func
